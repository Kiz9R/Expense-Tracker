...
| RUN | [VALIDATION.md](VALIDATION.md); historical PDF run includes private-sample validation. Latest 14 September sample-validation run: 45 JVM passed, including the private XML audit; Android runner OK (53 tests), comprising 51 executed passes and two opt-in skips. Earlier receiver-broadcast and private-PDF passes remain dated evidence and were not repeated in this run. Lint zero errors / 16 warnings; signed version 1.2.1/code 4 built and verified. No physical phone sign-off. |
...
| F040 Release APK and installation | §§2,70–71; M7 | MVP deliverable | Partial | Recorded pass: RUN version 1.2.1 debug/test install, release assembly and v2 signing verification; 45 JVM/51 executed Android tests | Optimized signed APK with schema-2 migration; README and supported PDF layout updated. | 16 lint warnings remain; physical install/update, recovery and accessibility are unverified (F035/F038). | Verify phone install/update/recovery and resolve actionable warnings. |
